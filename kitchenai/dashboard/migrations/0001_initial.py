# Generated by Django 5.1.2 on 2025-01-24 18:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("embedding_tokens", models.IntegerField(default=0, null=True)),
                ("llm_prompt_tokens", models.IntegerField(default=0, null=True)),
                ("llm_completion_tokens", models.IntegerField(default=0, null=True)),
                ("total_llm_tokens", models.IntegerField(default=0, null=True)),
                (
                    "chat",
                    models.ForeignKey(
